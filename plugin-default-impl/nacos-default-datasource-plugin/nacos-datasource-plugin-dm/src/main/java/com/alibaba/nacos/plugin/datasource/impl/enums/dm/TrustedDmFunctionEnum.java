...
package com.alibaba.nacos.plugin.datasource.impl.enums.dm;

import java.util.HashMap;
import java.util.Map;

/**
 * The TrustedDmFunctionEnum enum class is used to enumerate and manage a list of trusted built-in SQL functions.
