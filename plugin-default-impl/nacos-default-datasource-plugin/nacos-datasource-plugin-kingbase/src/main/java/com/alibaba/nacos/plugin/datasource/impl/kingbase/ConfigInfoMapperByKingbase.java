...
public class ConfigInfoMapperByKingbase extends AbstractMapperByKingbase implements ConfigInfoMapper {
    ...
    public MapperResult findConfigInfoByAppFetchRows(MapperContext context) {
        ...
        String sql = "SELECT id,data_id,group_id,tenant_id,app_name,content FROM config_info"
                + " WHERE tenant_id LIKE ? AND app_name= ?" + " ORDER BY id LIMIT ? OFFSET ?";
        return new MapperResult(sql, CollectionUtils.list(tenantId, appName, context.getPageSize(), context.getStartRow()));
    }
    
    @Override
    public MapperResult getTenantIdList(MapperContext context) {
        String sql = "SELECT tenant_id FROM config_info WHERE tenant_id != '" + NamespaceUtil.getNamespaceDefaultId()
                + "' GROUP BY tenant_id ORDER BY tenant_id LIMIT ? OFFSET ?";
    ...
    public MapperResult getGroupIdList(MapperContext context) {
        String sql = "SELECT group_id FROM config_info WHERE tenant_id ='" + NamespaceUtil.getNamespaceDefaultId()
                + "' GROUP BY group_id ORDER BY group_id LIMIT ? OFFSET ?";
        return new MapperResult(sql, CollectionUtils.list(context.getPageSize(), context.getStartRow()));
    }
    ...
    public MapperResult findChangeConfigFetchRows(MapperContext context) {
        ...
        return new MapperResult(
                sqlFetchRows + where + " AND id > ? ORDER BY id ASC LIMIT ? OFFSET ?", paramList);
    }
    ...
    public MapperResult findConfigInfoBaseLikeFetchRows(MapperContext context) {
        ...
        return new MapperResult(sqlFetchRows + where + " ORDER BY id LIMIT ? OFFSET ?", paramList);
    }
    ...
    public MapperResult findConfigInfo4PageFetchRows(MapperContext context) {
        ...
        final String sql = "SELECT a.id,a.data_id,a.group_id,a.tenant_id,a.app_name,a.content,a.md5,a.type,a.encrypted_data_key,a.c_desc,"
                          + "string_agg(b.tag_name, ',' ORDER BY b.tag_name) as config_tags "
